...
namespace ControlApp.Repository.Migrations
{
    ...
    [Migration("20230130101813_inventory createddate configuration")]
    partial class inventorycreateddateconfiguration
    {
            ...
            modelBuilder.Entity("ControlApp.Core.Entities.Abstract.SentryDone", b =>
                {
                    ...
                    b.HasOne("ControlApp.Core.Entities.Abstract.User", "User")
                        .WithMany()
